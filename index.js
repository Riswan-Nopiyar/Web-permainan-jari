  ...
  let S = { p1l:1, p1r:1, p2l:1, p2r:1, turn: Math.random()<0.5?1:2, sel:null, over:false };
  ...
  $('resetBtn').addEventListener('click', ()=>{
    ...
    render();
    if (firstTurn===2) setTimeout(botPlay, 800);
  });

  // ─── INIT ────────────────────────────────────────────────
  const startMsg = S.turn===1 ? 'Kamu duluan! Pilih tangan lalu klik tangan lawan.' : 'Bot duluan!';
  showMsg(startMsg);
  render();
  if (S.turn===2) setTimeout(botPlay, 900);
})();